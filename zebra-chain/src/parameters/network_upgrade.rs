...
pub(super) const MAINNET_ACTIVATION_HEIGHTS: &[(block::Height, NetworkUpgrade)] = &[
    ...
    // FIXME: TODO: Use a proper value below when Nu6_1 activation height is known for mainnet.
    // Nu6_1 does not yet have an activation height on mainnet.
